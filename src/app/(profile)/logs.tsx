...
export default function LogsScreen() {
  ...
  return (
    <Screen className="px-4" style={{ width: '100%', maxWidth: 900, alignSelf: 'center' }}>
      ...
      <View className="mb-3 flex-row items-center gap-2 rounded-xl border border-border bg-card px-3"><Icon as={Search} size={17} className="text-muted-foreground" /><Input value={query} onChangeText={setQuery} placeholder={t('dfLogsSearchPlaceholder')} className="flex-1 border-0 px-0" /></View>
      <FlatList
        data={filtered}
